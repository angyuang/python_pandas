...
![img](./images/python_pandas/wps69.jpg) 

点击右下方[Skip registration](https://www.anaconda.com/download/success)跳过注册

![img](./images/python_pandas/wps70.jpg) 

点击Download下载，或选择相应的操作系统和版本进行下载

![img](./images/python_pandas/wps71.jpg) 

 

双击安装包进入安装

![img](./images/python_pandas/wps72.jpg) 

点击Next

![img](./images/python_pandas/wps73.jpg) 

点击I Agree

![img](./images/python_pandas/wps74.jpg) 

点击Next

![img](./images/python_pandas/wps75.jpg) 

修改安装路径，点击Next

![img](./images/python_pandas/wps76.jpg) 
...
![img](./images/python_pandas/wps77.jpg) 

安装完成后，点击Next

![img](./images/python_pandas/wps78.jpg) 

再次点击Next

![img](./images/python_pandas/wps79.jpg) 

点击Finish，完成安装

![img](./images/python_pandas/wps80.jpg) 
...
![img](./images/python_pandas/wps81.jpg) 
...
![img](./images/python_pandas/wps82.jpg) 

![img](./images/python_pandas/wps83.jpg) 
...
i. **NumPy 切菜**：准备好数据（比如切好“销售额”和“成本”数组）。

ii. **Pandas 炒菜**：计算利润（销售额 - 成本），分析哪些产品赚钱。

iii. **可视化 摆盘**：用柱状图展示利润最高的产品，老板秒懂！
...
```python
Python列表耗时: 0.1256s   NumPy数组耗时: 0.0023s
```
...
![img](./images/python_pandas/wps84.jpg) 

**如果在**Pycharm中加载不出来，可以通过如下命令安装

```pyothon
C:\Users\fuxiaofeng>conda activate python-2025-conda (python-2025-conda) C:\Users\fuxiaofeng>conda install numpy
```
...
![img](./images/python_pandas/wps85.png)
...
![img](./images/python_pandas/wps86.jpg) 
...
![img](./images/python_pandas/wps87.jpg) 

可以写成矩阵形式：

![img](./images/python_pandas/wps88.jpg) 
...
![img](./images/python_pandas/wps89.jpg) 

用在向量 [xy][*xy*] 上，会使其旋转 θ*θ* 角度。
...
![img](./images/python_pandas/wps90.jpg) 

(2) 矩阵数乘

矩阵的每个元素乘以一个标量（数）：

![img](./images/python_pandas/wps91.jpg) 

(3) 矩阵乘法

矩阵乘法 不是 对应元素相乘，而是 行 × 列 的点积运算：

![img](./images/python_pandas/wps92.jpg) 
...
![img](./images/python_pandas/wps93.jpg) 

 

#### 2.2.3.4. 特殊矩阵

![img](./images/python_pandas/wps94.jpg) 
...
![img](./images/python_pandas/wps95.png)
...
| ----------------------------------------------------------- | -------------------- | ------------------------------------------------------------ |
| **bool**                                                    |                      | 布尔类型                                                     |
| **int8、uint8 、int16、uint16、int32、uint32int64、uint64** | i1,u1i2,u2i4,u4i8,u8 | 有符号、无符号的8位（1字节）整型有符号、无符号的16位（2字节）整型有符号、无符号的32位（4字节）整型有符号、无符号的64位（8字节）整型 |
| **float16、float32、float64**                               | f2f4或ff8或d         | 半精度浮点型单精度浮点型双精度浮点型                         |
| **complex64、complex128**                                   | c8c16                | 用两个32位浮点数表示的复数用两个64位浮点数表示的复数         |
...
Python import numpy as np  a = np.array([1, 2, 3]) b = np.array([4, 5, 6]) c = a + b  # 矢量化加法 → [5, 7, 9]
...
| 矢量化运算                  | 特性         | 广播机制                       |
| --------------------------- | ------------ | ------------------------------ |
| 避免显式循环，提升计算效率  | **目标**     | 解决不同形状数组的运算问题     |
| 广播机制是矢量化运算的补充  | **依赖关系** | 广播机制使矢量化运算更灵活     |
| 通常要求数组形状相同        | **形状要求** | 允许形状不同，但需满足广播规则 |
| 基于优化过的 C/Fortran 代码 | **底层实现** | 自动扩展数组，不实际复制数据   |
...
| np.select(condition,result) | 根据条件选择元素,返回结果                 | np.select([score>80,(score>60) &(score <80),score <60,],[‘ok’,’60’,,’no’],default=null) | [“ok”,”60”,”no”] |
...
![img](./images/python_pandas/wps96.jpg) 
...
| ![img](./images/python_pandas/wps97.jpg) | ![img](./images/python_pandas/wps98.jpg) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |
...
![img](./images/python_pandas/wps99.jpg) 
...
![img](./images/python_pandas/wps100.png)
...
![img](./images/python_pandas/wps101.jpg) 
...
![img](./images/python_pandas/wps102.jpg) 
...
![img](./images/python_pandas/wps103.jpg) 
...
![img](./images/python_pandas/wps104.png)

***\*常见图表类型及使用场景\****

![img](./images/python_pandas/wps105.png)

***\*好图的标准是什么？\****

![img](./images/python_pandas/wps106.png) 错误案例举例：
...
![img](./images/python_pandas/wps107.png)
...
![img](./images/python_pandas/wps108.png)
...
![img](./images/python_pandas/wps109.jpg) 
...
![img](./images/python_pandas/wps110.jpg) 
...
![img](./images/python_pandas/wps111.jpg) 
...
![img](./images/python_pandas/wps112.jpg) 
...
![img](./images/python_pandas/wps113.jpg) 
...
![img](./images/python_pandas/wps114.jpg) 
...
![img](./images/python_pandas/wps115.jpg) 
...
![img](./images/python_pandas/wps116.jpg) 
...
![img](./images/python_pandas/wps117.jpg) 
...
![img](./images/python_pandas/wps118.jpg) 
...
![img](./images/python_pandas/wps119.jpg) 
...
![img](./images/python_pandas/wps120.jpg) 
...
![img](./images/python_pandas/wps121.jpg) 
...
![img](./images/python_pandas/wps122.jpg) 
...
![img](./images/python_pandas/wps123.jpg) 
...
![img](./images/python_pandas/wps124.jpg) 
...
![img](./images/python_pandas/wps125.jpg) 
...
![img](./images/python_pandas/wps126.jpg) 
...
![img](./images/python_pandas/wps127.jpg) 
...
![img](./images/python_pandas/wps128.jpg) 
...
![img](./images/python_pandas/wps129.jpg) 
...
![img](./images/python_pandas/wps130.jpg) 
...
![img](./images/python_pandas/wps131.jpg) 
...
![img](./images/python_pandas/wps132.jpg) 
...
![img](./images/python_pandas/wps133.jpg) 
...
![img](./images/python_pandas/wps134.jpg) 
...
![img](./images/python_pandas/wps135.jpg) 
...
![img](./images/python_pandas/wps136.jpg) 
